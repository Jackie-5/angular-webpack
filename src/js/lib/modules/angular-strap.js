...
(function (window, document, undefined) {
    ...
    angular.module('mgcrea.ngStrap.datepicker', ['mgcrea.ngStrap.helpers.dateParser', 'mgcrea.ngStrap.helpers.dateFormatter', 'mgcrea.ngStrap.tooltip']).provider('$datepicker', function () {
        ...
        this.$get = ['$dateFormatter', '$dateParser', '$sce', function ($dateFormatter, $dateParser, $sce) {
            return function (picker) {
                ...
                var weekDaysMin = ['周日', '周一', '周二', '周三', '周四', '周五', '周六'];
                ...
                var views = [{
                    ...
                    build: function () {
                        var monthCn = [{key: 'January', value: '一月'}, {key: 'February', value: '二月'}, {
                            key: 'March',
                            value: '三月'
                        }, {key: 'April', value: '四月'}, {key: 'May', value: '五月'}, {key: 'June', value: '六月'}, {
                            key: 'July',
                            value: '七月'
                        }, {key: 'August', value: '八月'}, {key: 'September', value: '九月'}, {
                            key: 'October',
                            value: '十月'
                        }, {
                            key: 'November',
                            value: '十一月'
                        }, {key: 'December', value: '十二月'}];
                        var title = '';
                        ...
                        monthCn.forEach(function (item) {
                            if (item.key === formatDate(firstDayOfMonth, options.monthTitleFormat.split(' ')[0])) {
                                title = item.value + ' ' + formatDate(firstDayOfMonth, options.monthTitleFormat.split(' ')[1])
                            }
                        });
                        scope.title = title;
                    ...
                    build: function () {
                        ...
                        var month;
                        var _this = this;
                        var monthCn = [{key: 'Jan', value: '一月'}, {key: 'Feb', value: '二月'}, {
                            key: 'Mar',
                            value: '三月'
                        }, {key: 'Apr', value: '四月'}, {key: 'May', value: '五月'}, {key: 'Jun', value: '六月'}, {
                            key: 'Jul',
                            value: '七月'
                        }, {key: 'Aug', value: '八月'}, {key: 'Sep', value: '九月'}, {key: 'Oct', value: '十月'}, {
                            key: 'Nov',
                            value: '十一月'
                        }, {key: 'Dec', value: '十二月'}];
                        for (var i = 0; i < 12; i++) {
                            ...
                            var obj = {};
                            monthCn.forEach(function (item) {
                                if (item.key === formatDate(month, _this.format)) {
                                    obj.label = item.value
                                }
                            });
                            obj.date = month;
                            obj.selected = picker.$isSelected(month);
                            obj.disabled = this.isDisabled(month);
                            months.push(obj);
                        }
    ...
    angular.module('mgcrea.ngStrap.collapse', []).provider('$collapse', function () {
        ...
        var controller = this.controller = function ($scope, $element, $attrs) {
            ...
            $scope.$watch('activePanels', function (value) {
                activateItem(value)
            })
    ...
    }).directive('bsCollapseTarget', ['$animate', '$timeout', function ($animate, $timeout) {
        return {
            require: ['^?ngModel', '^bsCollapse'],
            link: function postLink(scope, element, attrs, controllers) {
                var bsCollapseCtrl = controllers[1];
                ...
                function render() {
                    ...
                    //
                    $timeout(function(){
                        $animate[JSON.parse(attrs.isopen) ? 'addClass' : 'removeClass'](element, bsCollapseCtrl.$options.activeClass);
                    },200);
